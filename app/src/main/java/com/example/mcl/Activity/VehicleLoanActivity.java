...
import com.example.mcl.databinding.VehicleLoanActivityBinding;
...
public class VehicleLoanActivity extends AppCompatActivity {
    private VehicleLoanActivityBinding binding;
    private Context context;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.vehicle_loan_activity);
        context = this;
        clickMethod();
    }
